...
/* 新增背景点击反馈 */
body {
    cursor: pointer; /* 整个页面显示可点击手势 */
    min-height: 100vh;
}

/* 排除容器区域的点击样式 */
.container {
    cursor: default; /* 容器内恢复默认光标 */
    position: relative; /* 建立新的层叠上下文 */
    z-index: 1;
    background: v0px; /* 保持原有内边距 */
}
...
<div class="container">
    <h1 id="guaTitle" style="border-bottom: 1px solid var(--primary-color);font-size: 2.5em;">易经的卦变</h1>
    <button id="yaoBtn">重新摇卦</button>
...
`;
    ...
    <div style="margin-top: 2rem; text-align: left; max-width: 650px; margin-inline: auto">
        ...
        <ul style="font-size: 1.3rem;list-style: none; padding: 0">
            ...
            <li><strong>------</strong></li>            
            <li><strong>天地没有隐藏自身变化，可以观测。</strong></li>
            <li><strong>天一地二，上下定位的两卦，训练脑子自行举一反十</strong></li>
        </ul>
        <small style="color: var(--accent-color); display: block; margin-top: 1rem;font-size: 1.1rem;  ">
            --------------
                ...
                <ul style="font-size: 1.3rem;list-style: none; padding: 0">
            <li>天再怎么转变还是天☰，地再怎么转变还是地☷</li>
            <li>水再怎么转变还是水☵，火再怎么转变还是火☲</li>
            <li>雷☳一转变就成了山☶，风☴一转变就成了泽☱</li>
        <small style="color: var(--accent-color); display: block; margin-top: 1rem;font-size: 1.1rem;  ">
            --------------
        </small>
            <li>相关成语：气势磅礴、遗风余泽</li>
            <li>雷和山都有势能，风里泽里都有混杂万物</li>           
        </ul>
        
        
         <ul style="font-size: 3rem;list-style: none; padding: 0">
            <li><strong> 乾为天（☰）、坤为地（☷）</strong></li> 
            <li><strong> 坎为水（☵）、离为火（☲）</strong></li>          
            <li><strong> 震为雷（☳）、巽为风（☴）</strong></li>
            <li><strong> 艮为山（☶）、兑为泽（☱）</strong></li>
        </ul>

         <ul style="font-size: 3rem;list-style: none; padding: 0">
            <li><strong> 《说卦传》：</strong></li>           
            <li><strong> 天地定位。山泽通气。</strong></li>
            <li><strong> 雷风相薄。水火不相射。</strong></li>
            <li><strong> 八卦相错。</strong></li>
        </ul>
...
// 在原有代码基础上添加以下内容
document.getElementById('guaTitle').addEventListener('click', startLottery);
